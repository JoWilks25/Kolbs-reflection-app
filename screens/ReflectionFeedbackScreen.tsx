  ...
  const handleFinish = async () => {
    try {
      ...
      const payload = {
        ...
        ai_questions_shown: reflectionDraft.aiQuestionsShown,
        ai_followups_shown: reflectionDraft.aiFollowupsShown,
        ai_followups_answered: reflectionDraft.aiFollowupsAnswered,
        step2_question: reflectionDraft.step2Question,
        step3_question: reflectionDraft.step3Question,
        step4_question: reflectionDraft.step4Question,
      ...
      if (existingReflection) {
        await updateReflection(sessionId, {
          ...
          ai_questions_shown: payload.ai_questions_shown,
          ai_followups_shown: payload.ai_followups_shown,
          ai_followups_answered: payload.ai_followups_answered,
          step2_question: payload.step2_question,
          step3_question: payload.step3_question,
          step4_question: payload.step4_question,
